# Arquitectura Frontend - cognIA

## Descripción general

La arquitectura del frontend de cognIA sigue un patrón modular basado en componentes React con TypeScript, implementando una separación clara de responsabilidades y un sistema de estilos centralizado. El proyecto está diseñado para ser escalable, mantenible y completamente responsive.
...
- **Componentes**: PascalCase (`Header`, `NuestroSistema`)
- **Archivos**: Mismo nombre que el componente
- **CSS classes**: kebab-case (`.sistema`, `.rf-container`)
